set terminal post enhanced colour solid font 21  # wybor formatu, w jakim chcemy utworzyc wynikowy rysunek
...
# 1. kolumna: xw[i]
# 2. kolumna: m[i]
# 3. kolumna: iloraz roznicowy (15) obliczony w punkcie xw[i] -- podpisany jako "numeryczny"
