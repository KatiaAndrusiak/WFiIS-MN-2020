...
set style line 1 pt 7 ps 0.6 lc rgb "red"               
set style line 2 pt 7 ps 0.6 lc rgb "blue" 
set style line 3 pt 7 ps 0.2 lw 2 lc rgb "dark-green"
set style line 4 pt 7 ps 0.2 lw 2 lc rgb "gray"
